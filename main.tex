...
\begin{minipage}{0.45\textwidth}
    \centering
    \begin{itemize}
        \item \textbf{Critic design:} DQN
        \item \textbf{Actor design:} DDPG, SAC
        \item \textbf{Learning signal:} A2C, GAE
        \item \textbf{Policy update:} TRPO, PPO
    \end{itemize}
    \end{minipage}
    \hfill
    \begin{minipage}{0.53\textwidth}
    \centering
    \includegraphics[width=\textwidth]{imgs/Actor_Critic.png}
...
\begin{itemize}
    ...
    $$
    to achieve more exploration~(\ie higher $\alpha$) in early training and more exploitation~(\ie lower $\alpha$) in later training.
